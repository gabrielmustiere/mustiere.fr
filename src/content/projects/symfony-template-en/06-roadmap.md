...
The goal isn't to add everything that might be useful, but only what I end up rebuilding by hand in my real projects. The rest stays outside the template — out
of respect for whoever clones it and won't want to spend two hours uninstalling things they don't use.
