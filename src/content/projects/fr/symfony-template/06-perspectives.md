...
L'idée n'est pas d'ajouter tout ce qui pourrait servir, mais seulement ce que je finis systématiquement par reconstruire à la main dans mes projets réels. Le
reste reste en dehors du template — par respect pour la personne qui va cloner et ne voudra pas passer deux heures à désinstaller ce qu'elle n'utilise pas.
